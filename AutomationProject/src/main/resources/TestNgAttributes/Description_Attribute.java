...
public class Description_Attribute extends BaseOrCommon {
	...
	@Test(priority =  1, timeOut = 5000, description = "this method is used to enter username in the username textbox")
	...
	@Test(priority =  3, description = "this method is used to click on the login button in the login page")
